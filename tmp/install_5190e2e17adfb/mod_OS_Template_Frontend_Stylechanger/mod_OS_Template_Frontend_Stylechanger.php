...
$query = "SELECT params FROM #__template_styles WHERE template='".$template_name."'";
$database=Jfactory::getDBO();
$database->setQuery($query);
// pulling all the elements of the template from the database
$categories = (array) json_decode($database->loadResult());
	...
	<div class="blockMain">
		...
		<div class="blockPattern">
			...
			<div style="margin:82px 0px 6px 0px;">
				<a href="http://www.ordasoft.com.ua"><img src='<?php echo $url."modules/".$app->scope."/images/ordasoft-logo.png";?>' width="107" height="17" alt="OrdaSoft"/></a>
			</div>
		</div>
	</div>
</div>
