...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LatestCommentsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?>">
			...
			<span class="lcUsername"><?php echo '<i class="fa fa-user"></i>';//JText::_('K2_WRITTEN_BY'); ?>
			...
			<span class="lcCommentDate">
				...
				<?php else: ?>
				<?php echo '<br>'. '<i class="fa fa-clock-o"></i>';//JText::_('K2_ON'); ?> <?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2')); ?>
				<?php endif; ?>
			</span>
			<?php endif; ?>
