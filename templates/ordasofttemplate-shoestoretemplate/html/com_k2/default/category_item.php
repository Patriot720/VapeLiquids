...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemdot">
		<?php if($this->item->params->get('catItemDateCreated')): ?>
		<!-- Date created -->
		<span class="catItemDateCreated">
			<?php echo '<i class="fa fa-clock-o"></i> ' . JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?>
		</span>
		<?php endif; ?>
		...
		<span class="catItemAuthor">
			<?php echo '<i class="fa fa-user"></i> ';//K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?> 
		...
		<div class="catItemCategory">
			<span><?php echo '<i class="fa fa-folder-open-o"></i> ';//JText::_('K2_PUBLISHED_IN'); ?></span>
		...
		<div class="catItemHitsBlock">
			<span class="catItemHits">
				<?php echo '<i class="fa fa-eye"></i> ';//JText::_('K2_READ'); ?> <b><?php echo $this->item->hits; ?></b> <?php echo JText::_('K2_TIMES'); ?>
			</span>
		</div>
		<?php endif; ?>
		...
		<div class="catItemCommentsLink">
			...
			<?php else: ?>
				...
				<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
					<?php echo '<i class="fa fa-comments-o"></i> ' . $this->item->numOfComments; ?> <?php echo '<i class="fa fa-comments-o"></i> ' . ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
				</a>
				<?php else: ?>
				<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
					<?php echo '<i class="fa fa-comments-o"></i> ' . JText::_('K2_BE_THE_FIRST_TO_COMMENT'); ?>
				</a>
				<?php endif; ?>
			<?php endif; ?>
		</div>
  ...
  <div class="clr"></div>
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore" href="<?php echo $this->item->link; ?>">
			<?php echo JText::_('K2_READ_MORE'); ?> <i class="fa fa-chevron-right"></i>
		</a>
	</div>
	<?php endif; ?>
	...
	<span class="catItemDateModified">
		<?php echo '<i class="fa fa-clock-o"></i> ' . JText::_('K2_LAST_MODIFIED_ON'); ?> <?php echo JHTML::_('date', $this->item->modified, JText::_('K2_DATE_FORMAT_LC2')); ?>
	</span>
	<?php endif; ?>
	<?php endif; ?>
