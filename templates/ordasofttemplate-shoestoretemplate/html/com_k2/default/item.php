...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
			...
			<li>
				<?php if($this->item->params->get('itemAuthor')): ?>
					...
					<span class="itemAuthor">
						<?php echo '<i class="fa fa-user"></i>';//echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>&nbsp;
  ...
  <div class="itemBody">
	  ...
	  <?php endif; ?>
		...
		<?php if($this->item->params->get('itemCategory') || $this->item->params->get('itemHits') || ($this->item->params->get('itemDateModified') && intval($this->item->modified)!=0)): ?>
...
<li class="modified">
			...
			<span class="itemDateModified">
				<?php echo '<i class="fa fa-clock-o"></i>'; //echo JText::_('K2_LAST_MODIFIED_ON'); ?> <?php echo JHTML::_('date', $this->item->modified, JText::_('K2_DATE_FORMAT_LC2')); ?>
			</span>
			<?php endif; ?>
</li>
</ul>	
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
	    	...
	    	<span class="commentLink">
		    	...
		    	<?php echo '<i class="fa fa-clock-o"></i> ' . JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2')); ?>
		    </span>
